<template>
  <div>
    <div
      class="album-header"
      :style="{ backgroundImage: 'url(http://music.163.com/api/img/blur/' + albumData.pic + ')' }"
    >
      <div class="album-wrap">
        ...
        <div class="header-text">
          ...
          <span>
            歌手：
            <i class="singer-name">{{albumData.artist.name}}</i>
          </span>
...
.album-header {
  ...
  .header-img {
    ...
    .ablumImg-bg {
      ...
      right: 6px;
      top: 4px;
      background: url("~@/assets/img/ablum-bg.png") no-repeat 0 center / 100%
        100%;
    }
    i {
      position: absolute;
