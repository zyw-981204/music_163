<template>
  <div class="player" v-show="isShowPlayer">
    <div class="player-icon" @click="isShowControl = true">
      <i class="fa fa-music" :style="{ 'animation-play-state': isPlay ? 'running' : 'paused' }"></i>
    </div>
...
export default {
  ...
  methods: {
    async palySong(numSIgn) {
      //numSIgn：-1表示前一首歌，1表示下一首歌
